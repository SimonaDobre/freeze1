...
mixin _$Torrent {
  ...
  String get date_uploaded => throw _privateConstructorUsedError;
...
abstract class $TorrentCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, String hash, String quality, String date_uploaded});
}
    ...
    return _then(_value.copyWith(
      ...
      quality: null == quality
          ...
          : quality // ignore: cast_nullable_to_non_nullable
              as String,
      date_uploaded: null == date_uploaded
          ? _value.date_uploaded
          : date_uploaded // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
class _$Torrent$ implements Torrent$ {
  ...
  @override
  String toString() {
    return 'Torrent(url: $url, hash: $hash, quality: $quality, date_uploaded: $date_uploaded)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.date_uploaded, date_uploaded) ||
                other.date_uploaded == date_uploaded));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, url, hash, quality, date_uploaded);
...
abstract class Torrent$ implements Torrent {
  const factory Torrent$(
      ...
      required final String date_uploaded}) = _$Torrent$;
